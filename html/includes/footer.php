                    ...
                    <div class="footer-two-main-wrapper">
                        <div class="footer-single-wixed-two start">
                            <a href="#" class="logo-area">
                                <img src="assets/images/logo/logo.png" alt="logo-area" class="logo">
                            </a>
                            <p class="disc">
                        ...
                        <div class="single-footer-wized mid pt-5 pt-md-0">
                            ...
                            <div class="footer-nav">
                                <ul>
                                    <li><a href="products.php">Pickles</a></li>
                                    <li><a href="products.php">Sweets</a></li>
                                    <li><a href="products.php">Powders</a></li>
                                    <li><a href="products.php">Sweets</a></li>
                                    <li><a href="products.php">Ghee</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="single-footer-wized mid pt-5 pt-md-0">
                        ...
                        <div class="single-footer-wized pt-5 pt-md-0">
                            ...
                            <div class="contact-information">
                                ...
                                <div class="single-contact-information-area">
                                    <div class="icon-area">
                                        <img src="assets/images/icons/address.svg" alt="icons">
                                    </div>
                                ...
                                <div class="single-contact-information-area">
                                    <div class="icon-area">
                                        <img src="assets/images/icons/phone.svg" alt="icons">
                                    </div>
                                    <div class="information-area">
                                        <p class="disc">
                                            Call to us <br>
                                ...
                                <div class="single-contact-information-area">
                                    <div class="icon-area">
                                        <img src="assets/images/icons/email.svg" alt="icons">
                                    </div>
                                    <div class="information-area">
                                        <p class="disc">
                                           Email Us <br>
