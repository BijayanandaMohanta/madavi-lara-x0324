                                ...
                                <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="single-shopping-card-one">
                                        ...
                                        <div class="image-and-action-area-wrapper">
                                            <a href="product-details.php" class="thumbnail-preview">

                                                <img src="assets/images/grocery/01.jpg" alt="">
                                            </a>
                                        ...
                                        <div class="body-content">
                                            ...
                                            <div class="cart-counter-action">
                                                <a href="product-details.php" class="rts-btn btn-primary radious-sm with-icon">
                                                    <div class="btn-text">
                                                       Order Now
                                                    </div>
                                                    <div class="arrow-icon">
                                    ...
                                    <div class="single-shopping-card-one">
                                        ...
                                        <div class="image-and-action-area-wrapper">
                                            <a href="product-details.php" class="thumbnail-preview">
                                                ...
                                                <img src="assets/images/grocery/02.jpg" alt="">
                                            </a>
                                    ...
                                    <div class="single-shopping-card-one">
                                        ...
                                        <div class="image-and-action-area-wrapper">
                                            <a href="#" class="thumbnail-preview">
                                                ...
                                                <img src="assets/images/grocery/09.jpg" alt="">
                                            </a>
                                    ...
                                    <div class="single-shopping-card-one">
                                        ...
                                        <div class="image-and-action-area-wrapper">
                                            <a href="#" class="thumbnail-preview">
                                                ...
                                                <img src="assets/images/grocery/10.jpg" alt="">
                                            </a>
...
<!-- rts customers feedbacka area start -->
    <div class="rts-cuystomers-feedback-area rts-section-gap">
        <div class="container-3">
            <div class="row">
            ...
            <div class="row g-5">
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        ...
                        <div class="information">
                            <h4 class="title">100% Homemade</h4>
                            <p class="disc">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        ...
                        <div class="information">
                            <h4 class="title">No Chemicals, No Preservatives</h4>
                            <p class="disc">
                                Pure and safe
                            </p>
                        </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        ...
                        <div class="information">
                            <h4 class="title">Made by Homemakers & Grannies</h4>
                            <p class="disc">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="single-short-service-area-start">
                        ...
                        <div class="information">
                            <h4 class="title">Traditional Recipes</h4>
                            <p class="disc">
