<?php include 'includes/headerstyles.php'?>
    <body>
        ...
        <?php if ($page == 'index.php') { ?>
            <div class="loader">
                <img class="img-responsive" src="images/logo.svg" alt="logo.jpg" />
            </div>
        <?php } ?>
                ...
                <div class="container-fluid">
                    <div class="header-nav-wrapper d-md-flex d-sm-flex d-xl-flex d-lg-flex justify-content-between">
                        <div class="header-static-nav">
                            <p><img src="images/icons/header-icons/right.svg" alt="top-right"> What is <span><a href="faqs.php">OPEN BOX?</a></span></p><p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. </p>
                        </div>
                        ...
                        <div class="col-xxl-7 col-xl-7  col-lg-8 col-md-12 col-sm-12 col-12 align-self-center">
                            <div class="header-right-element d-flex">
                                ...
                                <div class="header-nav">
                                    <ul class="menu-nav">
                                        <li>
                                            <a href="#" class="wishlist-bg"><img src="images/icons/header-icons/fav.svg" alt="wishlist"> </a>
                                        </li>
                                        <!-- <li>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu animation slideDownIn" aria-labelledby="dropdownMenuButton-3">
                                                    <div class="login-module border-0 pb-1">
                                                        <p>New Customer</p>
                                                        <h4><span><a href="login.php">Login/Sign Up</a></span></h4>
                                                    </div>
                                                </ul>
                                            </div>
                                        </li>
        ...
        <div class="offcanvas-body">
            <ul id="categoriesmenu">
                <li>
                    <a href="#" class="has-arrow">Electronics</a>
                    <ul class="greymenu">
                        <li>
                ...
                <li>
                    <a href="#" class="has-arrow">Video Games</a>
                    <ul class="submenu-item">
                        <li><a href="category-list.php">Handheld Game Players</a></li>
                        <li><a href="category-list.php">Game Controllers</a></li>
                        <li><a href="category-list.php">Joysticks</a></li>
