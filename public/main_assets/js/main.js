(function ($) {
  ...
  function thmOwlInit() {
    // owl slider
    let abrishowlCarousel = $('.abrish-owl__carousel');
    if (abrishowlCarousel.length) {
      abrishowlCarousel.each(function () {
        let elm = $(this);
    ...
    let abrishowlCarouselNav = $('.abrish-owl__carousel--custom-nav');
    if (abrishowlCarouselNav.length) {
      abrishowlCarouselNav.each(function () {
        let elm = $(this);
