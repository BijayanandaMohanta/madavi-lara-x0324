                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    @foreach ($banners as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->image != '')
                                                    <a href="{{ asset('uploads/ads') }}/{{ $data->image }}" target="_blank">
                                                        <img class="avatar-lg" src="{{ asset('uploads/ads') }}/{{ $data->image }}" >
                                                    </a>
                                                @else
...
<button data-value="{{ $data->id }}" class="btn btn-danger waves-effect waves-light btn-xs cdelete"><i class="fas fa-trash"></i></button>
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post" action="{{ route('ads.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                            </td>
