                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive">
                                    ...
                                    @foreach ($banners as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->image != '')
                                                    <a href="{{ asset('uploads/banners') }}/{{ $data->image }}" target="_blank">
                                                        <img class="avatar-lg" src="{{ asset('uploads/banners') }}/{{ $data->image }}" alt="{{ $data->heading }}">
                                                    </a>
                                                @else
...
<button data-value="{{ $data->id }}" class="btn btn-danger waves-effect waves-light btn-xs cdelete"><i class="fas fa-trash"></i></button>
                                            ...
                                            <form id="deleteform{{ $data->id }}" method="post" action="{{ route('banners.destroy', [$data->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                            </form>
                                            </td>
