                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="dropify @error('image') is-invalid @enderror"
                                            ...
                                            data-default-file="{{ asset('uploads/category/') }}/{{ $data->image }}">
                                        @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
                                        <span class="font-13 text-muted">* Image size <code>width : 300px</code> x
                                            <code>height : 300px upload only .png image for best quality.</code> </span>
                                        <br>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="category" value="{{ $data->category }}" autocomplete="off">
                                        @error('category')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
