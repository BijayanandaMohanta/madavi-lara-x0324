                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Faq Image</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Faq Image
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Faq Images</h4>
                            </div>
                        </div>
                        <hr>

                        <form id="form" method="post" action="{{ route('faq_image.store') }}"
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <kbd>Upload 16:9 images for better</kbd>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @foreach ($faq_images as $image)
                                        <div style="position: relative; display:inline-block;">
                                            <img data-src="{{ asset('uploads/faqs/' . $image->image) }}"
                                                style="width: 10rem;height: 10rem;object-fit: cover;margin-bottom:3px;border-radius: 2px;"
                                                class="lozad">
                                            <form method="post"
                                                action="{{ route('faq_image.destroy', $image->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
