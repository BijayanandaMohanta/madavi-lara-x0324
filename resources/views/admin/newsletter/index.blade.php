                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Newsletter Requests</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Newsletter Requests
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Newsletter Requests</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('newsletter_export') }}"
                                    class="btn btn-success btn-sm float-right ml-2">Export News Letter</a>
                            </div>
                        </div>
                        <hr>
