                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    @foreach ($apps as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->image != '')
                                                    <a href="{{ asset('uploads/notification') }}/{{ $data->image }}" target="_blank">
                                                        <img class="avatar-lg" src="{{ asset('uploads/notification') }}/{{ $data->image }}" alt="{{ $data->title }}">
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                   ...
                                                   <form id="deleteform{{ $data->id }}" method="post"
                                                        action="{{ route('notification.destroy', [$data->id]) }}">
                                                        @csrf
                                                       {{ method_field('DELETE') }}
                                                    </form>
                                            </td>
