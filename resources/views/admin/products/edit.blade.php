                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            name="min_stock" id="min_stock" value="{{ $data->min_stock }}">
                                        @error('min_stock')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('out_of_stock') is-invalid @enderror"
                                            name="out_of_stock" id="out_of_stock">
                                            <option value="Yes"
                                                {{ old('out_of_stock', $data->out_of_stock ?? "Yes") == "Yes" ? 'selected' : '' }}>Yes
                                            </option>
                                            <option value="No"
                                                {{ old('out_of_stock', $data->out_of_stock ?? "Yes") == "No" ? 'selected' : '' }}>
                                                No</option>
                                        </select>
                                        @error('out_of_stock')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            ...
                                            data-id="{{ $data->id }}" data-column="size_chart_image2"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            ...
                                            data-id="{{ $data->id }}" data-column="size_chart_image3"
