                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Video Review</li>
                            </ol>
                        </div>
                    @section('page_title')
                        Add Video Review
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="page-title">Add Video Review</h4>
                            </div>
                        </div>
                        <hr>
                        <form id="form" method="post" action="{{ route('videoreviews.store') }}"
                            enctype="multipart/form-data">@csrf

                            <div class="form-group d-none">
                                <label for="video">Video * :</label>
                                <input type="file" class="dropify @error('video') is-invalid @enderror"
                                    name="video" id="video" accept="video/mp4,video/mkv">
                                @error('video')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                <small>Dimension <code>1080 x 1920 pixels</code></small>
                            </div>
