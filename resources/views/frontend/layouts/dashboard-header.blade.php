            ...
            <div class="container-fluid">
                <div class="header-nav-wrapper d-md-flex d-sm-flex d-xl-flex d-lg-flex justify-content-between">
                    <div class="header-static-nav">
                        <p><img src="images/icons/header-icons/right.svg" alt="top-right"> What is <span><a
                                    href="#">OPEN BOX?</a></span></p>
                        <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those
                            interested. </p>
                    </div>
                    <div class="header-menu-nav">
                        <p><img src="images/icons/header-icons/bestdeal.svg" alt=""> Today's deal sale 50% off <a
                                href="category-list.php"><span>SHOP NOW!</span></a></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xxl-7 col-xl-7  col-lg-8 col-md-12 col-sm-12 col-12 align-self-center">
                        <div class="header-right-element d-flex">
                            ...
                            <div class="header-nav">
                                <ul class="menu-nav">
                                    <li>
                                        <a href="dashboard-wishlist.php" class="wishlist-bg"><img
                                                src="images/icons/header-icons/fav.svg" alt="wishlist"> </a>
                                    </li>
                                    <!-- <li>
                                    ...
                                    <li class="pr-0">
                                        <div class="dropdown">
                                            <a href="#" class="cart-addon" data-number="3" id="cartitembox"
                                                id="dropdownMenuButton-2" data-bs-toggle="dropdown"><img
                                                    src="images/icons/header-icons/cart.svg" alt=""> </a>
                                    ...
                                    <li class="pr-0">
                                        <div class="dropdown">
                                            <button type="button" id="dropdownMenuButton-3"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"><img src="images/icons/header-icons/profile.svg"
                                                    alt="">
                                            </button>
                                            ...
                                            <ul class="dropdown-menu animation slideDownIn"
                                                ...
                                                <div class="login-module pb-2">
                                                    <h4><span><a href="javascript:void()"
                                                                style="cursor:default!important">Dashboard</a></span>
                                                    </h4>
                                                </div>
                                                <li>
                                                    <a href="dashboard-myprofile.php"><img
                                                            src="images/icons/my-profile.png" alt=""> My
                                                        Profile</a>
                                                </li>
                                                <li>
                                                    <a href="dashboard-myorders.php"><img
                                                            src="images/icons/my-orders.png" alt="">
                                                        Orders</a>
                                                </li>
                                                <li>
                                                    <a href="dashboard-wishlist.php" data-number="3"><img
                                                            src="images/icons/my-whishlist.png" alt="">
                                                        Wishlist <span>0</span></a>
                                                </li>
                                                <li>
                                                    <a href="dashboard-rewards.php"><img
                                                            src="images/icons/my-rewards.png" alt=""> Rewards
                                                        Box</a>
                                                </li>
                                            </ul>
                                        </div>
        ...
        <div class="offcanvas-body">
            ...
            <ul id="topmenu">
                <li><a href="#" class="has-arrow">Dashboard Menu</a>
                    <ul>
                        <li><a href="dashboard-myprofile.php"><object data="images/dashboard/dashicon-1.svg"
                                    type="image/svg+xml"></object> My Profile</a></li>
                        <li><a href="dashboard-myorders.php"><object data="images/dashboard/dashicon-2.svg"
                                    type="image/svg+xml"></object> My Orders</a></li>
                        <li><a href="dashboard-wishlist.php"><object data="images/dashboard/dashicon-3.svg"
                                    type="image/svg+xml"></object> My Wishlist</a></li>
                        <li><a href="dashboard-address.php"><object data="images/dashboard/dashicon-4.svg"
                                    type="image/svg+xml"></object> Manage Address</a></li>
                        <li><a href="dashboard-reviews.php"><object data="images/dashboard/dashicon-5.svg"
                                    type="image/svg+xml"></object> Reviews & Ratings</a></li>
                        <li><a href="dashboard-rewards.php"><object data="images/dashboard/dashicon-6.svg"
                                    type="image/svg+xml"></object> Reward's Box</a></li>
                        <li><a href="#"><object data="images/dashboard/dashicon-7.svg"
                                    type="image/svg+xml"></object> Contact Us</a></li>
                        <li><a href="index.php"><object data="images/dashboard/dashicon-8.svg"
