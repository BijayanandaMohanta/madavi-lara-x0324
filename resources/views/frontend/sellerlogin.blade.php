                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                            ...
                            <div class="hide-show-yes">
                                <form action="{{ route('sellerchecklog') }}" method="POST" name="loginFormEmail"
                        ...
                        <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel"
                            ...
                            <form action="{{ route('sellerregister') }}" method="POST" id="registerForm"
                                autocomplete="off">
                                @csrf
                                <!-- #radio - hide/show -->
                                <div class="hide-show-yes mt-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="gst_number" type="text" class="form-control w-100" required>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="d-block">Shop Image/ Visiting Cart.</label>
                                        <input name="proof_image" type="file" class="form-control w-100" accept="image/jpg, image/jpeg, image/png" required>
                                    </div>
