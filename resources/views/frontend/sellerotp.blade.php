                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="login-content">
                        ...
                        <div class="otp-content mb-3">
                            ...
                            <p>Please Enter the OTP Sent To<span class="d-block">{{ $seller->mobile }}. <a
                                        href="{{ route('sellerlogin') }}">Change</a></span></p>
                        </div>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                aria-labelledby="home-tab" tabindex="0">
                                <form method="POST" action="{{ route('sellerotpverify') }}">
                                    <!-- #radio - hide/show -->
                                    @csrf
                                    <input type="hidden" name='action' value="{{ $action }}">
                                    <input type="hidden" name="token" value="{{ $seller->otp_token }}">
                        ...
                        <form method="POST" action="{{ route('sellerresendotp') }}" class="mt-3">
                            @csrf
                            <input type="hidden" name="token" value="{{ $seller->otp_token }}">
