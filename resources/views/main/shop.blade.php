...
@section('content')
    ...
    <section class="product">
        <div class="container">
            <?php $shoptitle = array("Byjus", "Khabri", "toppr", "Vedantu", "Unacademy");
            $shopimg = array("byju-logo", "khabri-logo", "toppr-logo", "vedantu-logo", "unacademy-logo");
            $arrlength = count($shoptitle);
            $arrlength = count($shopimg);
            ?>
            <div class="row">
                <?php for ($i = 0;
                           $i < $arrlength;
                ...
                <div class="col-lg-3 wow fadeInUp" data-wow-delay="100ms">
                    <div class="course-two__item">
                        <div class="course-two__thumb">
                            <a href="#" target="_blank"> <img src="{{ asset('main_assets') }}/images/<?php echo $shopimg[$i];?>.jpg"
                                                              alt="alabrish"></a>
                        </div>
                        <div class="course-two__content text-center">
                            <h3 class="course-two__title mb-1">
                                <a href="#" target="_blank"><?php echo $shoptitle[$i]; ?></a>
                            </h3>
                            <div class="course-two__bottom">
                                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a
                                    piece of classical Latin literature is not simply text.</p>
                            </div>
                        </div>
                    </div>
                </div>
